...
Toastmessage = WebUI.getText(findTestObject('Dashboard/Entity/Documents/Toast Upload Document'))

System.println(Toastmessage)

WebUI.click(findTestObject('Dashboard/Entity/Documents/Doc-Additionaldoc-downloaddoc/icon_download'))
