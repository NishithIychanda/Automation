...
toastmsgg = WebUI.getText(findTestObject('Dashboard/Entity/Documents/Toast Upload Document'))

System.println(toastmsgg)

WebUI.click(findTestObject('Dashboard/Entity/Documents/Verify Icon'))

veridytoast = WebUI.getText(findTestObject('Dashboard/Entity/Documents/Verify Toast Message'))

System.println(veridytoast)
