...
WebUI.click(findTestObject('Dashboard/Entity/Network/Network Details List/Network Name/network_AXIS BANK LIMITED'))

WebUI.click(findTestObject('Dashboard/Entity/Network/Network Details List/Network Type/Span_NetworkType'))

WebUI.click(findTestObject('Dashboard/Entity/Network/Network Details List/Network Type/NetworkType_Seller'))
