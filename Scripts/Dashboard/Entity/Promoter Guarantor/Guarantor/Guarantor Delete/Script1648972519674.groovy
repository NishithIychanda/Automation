...
WebUI.setText(findTestObject('Dashboard/Entity/Promoter Guarantor/Guarantor/Guarantor Information/Input/PAN'), '78982872')
...
WebUI.click(findTestObject('Dashboard/Entity/Promoter Guarantor/Guarantor/Delete Buttons/Close Icon'))

WebUI.click(findTestObject('Dashboard/Entity/Promoter Guarantor/Guarantor/Delete Buttons/Delete Icon'))

WebUI.click(findTestObject('Dashboard/Entity/Promoter Guarantor/Guarantor/Delete Buttons/Button_Delete'))

Toast_Message = WebUI.getText(findTestObject('Dashboard/Entity/Promoter Guarantor/Guarantor/Delete Buttons/Toast Message'))
