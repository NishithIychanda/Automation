...
WebUI.scrollToElement(findTestObject('Dashboard/Entity/Promoter Guarantor/Promoter/Bank Statements/Button/Button_Upload Statement'), 
    0)
...
WebUI.uploadFile(findTestObject('Dashboard/Entity/Promoter Guarantor/Promoter/Bank Statements/Upload/Upload file'), 'D:\\\\Demo\\\\bankStmt.pdf')
