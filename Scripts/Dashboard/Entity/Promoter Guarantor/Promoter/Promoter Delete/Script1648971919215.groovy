...
WebUI.setText(findTestObject('Dashboard/Entity/Promoter Guarantor/Promoter/Promoter Information/Input/PAN'), '78973892')

WebUI.setText(findTestObject('Dashboard/Entity/Promoter Guarantor/Promoter/Promoter Information/Input/AadharNumber'), '899266172703')

WebUI.setText(findTestObject('Dashboard/Entity/Promoter Guarantor/Promoter/Promoter Information/Input/Email'), 'delete+1@jai-kisan.com')

WebUI.setText(findTestObject('Dashboard/Entity/Promoter Guarantor/Promoter/Account Information/Input/Mobile Number'), '9898289811')
...
WebUI.click(findTestObject('Dashboard/Entity/Promoter Guarantor/Promoter/Delete Buttons/Close Icon'))

WebUI.click(findTestObject('Dashboard/Entity/Promoter Guarantor/Promoter/Delete Buttons/Delete Icon'))

WebUI.click(findTestObject('Dashboard/Entity/Promoter Guarantor/Promoter/Delete Buttons/Button_Delete'))

Toast_Message = WebUI.getText(findTestObject('Dashboard/Entity/Promoter Guarantor/Promoter/Delete Buttons/Toast Message'))
