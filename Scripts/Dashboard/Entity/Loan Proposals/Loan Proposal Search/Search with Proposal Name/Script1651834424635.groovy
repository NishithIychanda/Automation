...
WebUI.setText(findTestObject('Dashboard/Entity/Loan Proposals/Loan Proposal Search/input_SearchText'), SeachProposalName)

WebUI.delay(5)

FetchedProposalName = WebUI.getText(findTestObject('Dashboard/Entity/Loan Proposals/Loan Proposal Search/ProposalName'))

System.println(FetchedProposalName)

if (SeachProposalName == FetchedProposalName) {
