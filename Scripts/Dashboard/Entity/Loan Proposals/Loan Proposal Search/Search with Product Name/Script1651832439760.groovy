...
FetchedProductName = WebUI.getText(findTestObject('Dashboard/Entity/Loan Proposals/Loan Proposal Search/ProductName'))

System.println(FetchedProductName)

if (SeachProductName == FetchedProductName) {
