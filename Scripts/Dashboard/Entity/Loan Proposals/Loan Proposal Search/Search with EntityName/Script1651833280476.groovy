...
WebUI.setText(findTestObject('Dashboard/Entity/Loan Proposals/Loan Proposal Search/input_Proposal ID'), SeachEntityName)

WebUI.delay(5)

FetchedEntityName = WebUI.getText(findTestObject('Dashboard/Entity/Loan Proposals/Loan Proposal Search/Entity Name'))

System.println(FetchedEntityName)

if (SeachEntityName == FetchedEntityName) {
