...
WebUI.click(findTestObject('Dashboard/Entity/Loan Proposals(invoice Finance)/Proposal Details/Button_New Proposal'))

WebUI.setText(findTestObject('Dashboard/Entity/Loan Proposals(invoice Finance)/Proposal Details/input_Proposal Name'), 'Automation Invoice Finance')

WebUI.click(findTestObject('Dashboard/Entity/Loan Proposals(invoice Finance)/Proposal Details/span_Product Type'))

WebUI.click(findTestObject('Dashboard/Entity/Loan Proposals(invoice Finance)/Proposal Details/Dropdown_Invoice Finance'))

WebUI.click(findTestObject('Dashboard/Entity/Loan Proposals/Proposal Details/span_Invoice Finance Category'))

WebUI.click(findTestObject('Dashboard/Entity/Loan Proposals/Proposal Details/dropdown_Invoice Finance Category'))

WebUI.setText(findTestObject('Dashboard/Entity/Loan Proposals(invoice Finance)/Proposal Details/input_Proposed Loan Amount'), 
    '2000')

WebUI.setText(findTestObject('Dashboard/Entity/Loan Proposals(invoice Finance)/Proposal Details/input_ROI'), '2')

WebUI.setText(findTestObject('Dashboard/Entity/Loan Proposals(invoice Finance)/Proposal Details/input_Processing Fees'), 
    '2')

WebUI.setText(findTestObject('Dashboard/Entity/Loan Proposals(invoice Finance)/Proposal Details/FLDG or Cash Collateral Offered'), 
    '22')

WebUI.scrollToElement(findTestObject('Dashboard/Entity/Loan Proposals(invoice Finance)/Proposal Details/input_Global Margin'), 
    2)

WebUI.setText(findTestObject('Dashboard/Entity/Loan Proposals(invoice Finance)/Proposal Details/input_LTV'), '2')

WebUI.setText(findTestObject('Dashboard/Entity/Loan Proposals(invoice Finance)/Proposal Details/input_Tenure'), '2')
...
WebUI.setText(findTestObject('Dashboard/Entity/Loan Proposals/Proposal Details/input_Purpose Of loan'), 'Automation BNPL Proposal')
