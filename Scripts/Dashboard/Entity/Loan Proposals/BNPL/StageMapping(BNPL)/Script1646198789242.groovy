...
WebUI.click(findTestObject('Dashboard/Entity/Loan Proposals/Common/td_Automation Buy Now Pay Later'))
...
WebUI.click(findTestObject('Dashboard/Entity/Loan Proposals/StageMapping/CreateAttach Loan Scheme/LoanScheme_option(BNPL)'))
