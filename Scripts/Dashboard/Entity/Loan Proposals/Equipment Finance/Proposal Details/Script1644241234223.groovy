...
WebUI.setText(findTestObject('Dashboard/Entity/Loan Proposals/Proposal Details/Input-Attributes/input_Proposal Name'), 'Automation Equipment Finanace')

WebUI.click(findTestObject('Dashboard/Entity/Loan Proposals/Proposal Details/Loan Product/Loan_Product'))

WebUI.click(findTestObject('Dashboard/Entity/Loan Proposals/Proposal Details/Loan Product/Dropdown_Equipment Finance'))
...
WebUI.setText(findTestObject('Dashboard/Entity/Loan Proposals/Proposal Details/Input-Attributes/input_Purpose Of loan'), 'Automation Equipment loan Proposal')
