...
WebUI.click(findTestObject('Dashboard/Entity/Associated Client Tab/Primary Promoter'))

WebUI.click(findTestObject('Dashboard/Entity/Associated Client Tab/Guarantor Toggle Button'))

WebUI.click(findTestObject('Dashboard/Entity/Associated Client Tab/Authorized Signatory'))
