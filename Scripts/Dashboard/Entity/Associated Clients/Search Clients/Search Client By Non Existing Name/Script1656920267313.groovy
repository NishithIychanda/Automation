...
WebUI.setText(findTestObject('Dashboard/Entity/Associated Client Tab/Search Client By Name'), 'Annesh')

Message1 = WebUI.getText(findTestObject('Dashboard/Entity/Associated Client Tab/No Records Found Error'))
