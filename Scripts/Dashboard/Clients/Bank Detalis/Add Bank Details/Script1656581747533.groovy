...
WebUI.scrollToElement(findTestObject('Dashboard/Clients/Bank Details/Add Bank Account Button'), 2)

WebUI.click(findTestObject('Object Repository/Dashboard/Clients/Bank Details/Add Bank Account Button'))

WebUI.setText(findTestObject('Dashboard/Clients/Bank Details/Input Account Number'), '04640308711')
